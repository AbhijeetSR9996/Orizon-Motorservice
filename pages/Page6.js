                ...
                <View>
                    ...
                    <SafeAreaView style={styles.bg}>
                        <View style={styles.boundary}>
                            ...
                            <Text style={styles.txt1}>Do it right away.</Text>
                            <Separator />
                            <Separator />
                            <Separator />
                            <View style={styles.innerview}>
                                <TextInput placeholder='OTP' style={styles.txtin} keyboardType='numeric' placeholderTextColor='#808080' maxLength={6} secureTextEntry /></View>

                            <View style={styles.fixToText}>
                                <TouchableOpacity style={styles.appButtonContainer} onPress={() => navigation.navigate('Page2')} >
                                    <Text style={styles.appButtonText}>Verify OTP</Text>
                                </TouchableOpacity>
                                <Separator />
                                <Separator />
                                <Separator />
